...
// ======================================================
// 6. PRIVATE KEY -> NODE CRYPTO KEY OBJECT
// ======================================================
...
// ======================================================
// 7. GRPC CONNECTION SA PEER0.ORG1
// ======================================================
...
// ======================================================
// 11. SCENARIO 2
// Sumnjiva aktivnost / potencijalno neovlašćeni korisnik
// ======================================================
...
async function main() {
    ...
    try {
        ...
        // ==================================================
        // Postojeći registrovani korisnik
        // ==================================================

        const biometricId = "BIO004";
        const employeeId = "EMP004";

        // ==================================================
        // ID finansijske transakcije
        // ==================================================

        const transactionId = "TX002";

        // ==================================================
        // Simulacija biometrijskog pokušaja
        //
        // NAMERNO KORISTIMO DRUGAČIJE PODATKE
        // kako bi hash bio različit od registrovanog.
        // ==================================================

        const suspiciousBiometricData =
            "UNAUTHORIZED-USER-behavior-profile";

        const providedTemplateHash =
            createHash(suspiciousBiometricData);
        ...
        console.log(providedTemplateHash);
        ...
        console.log("Transaction decision: DENY");
        console.log("Reason: Behavioral biometric pattern mismatch");
        console.log("Status: SUSPICIOUS ACTIVITY DETECTED");
